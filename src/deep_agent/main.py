...
## **BUNDLED FILES**
There are files that you can refer to during performing user task. Update them for self improvement:
- `extended_tools.py`: introduces additional tools.
- `extended_tools_guidelines.md`: instructs you how to use additional tools.
- `memory_base.txt`: important records left after previous sessions. A long-term memory.
- `extended_system_prompt.md`: document expanding original system prompt that can be updated dynamically.
